...
//        bottomNavBar.sizeThatFitsIncludesSafeArea = false
        ...
        bottomNavBar.applyPrimaryTheme(withScheme: ApplicationScheme.shared.containerScheme)
...
//        NotificationCenter.default.addObserver(self, selector:#selector(showFeedback), name: NSNotification.Name.UIApplication.willEnterForegroundNotification, object: nil)
        showFeedback()
    }
