...
class ScheduleComponent(
    ...
    showAttendingIndicators = true,
    scheduleItems = { sessionGateway.observeSchedule().first() },
    ...
    class Factory(
        ...
        fun create(
            componentContext: ComponentContext,
            sessionSelected: (Session.Id) -> Unit,
        ) = ScheduleComponent(componentContext, dispatchers, sessionGateway, sessionDaysFactory, dateTimeService, sessionSelected)
    }
}
