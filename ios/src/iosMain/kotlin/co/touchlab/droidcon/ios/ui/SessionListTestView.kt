...
@Composable
internal fun SessionListTestView(viewModel: BaseSessionListViewModel) {
...
fun getRootController(viewModel: BaseSessionListViewModel) =
    Application("SessionListTestView") {
        SessionListTestView(viewModel)
    }
