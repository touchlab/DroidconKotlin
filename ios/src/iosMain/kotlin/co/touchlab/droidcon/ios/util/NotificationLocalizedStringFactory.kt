    ...
    override fun reminderTitle(roomName: String?): String {
        val ending = roomName?.let {
            NSString.stringWithFormat(
                bundle.localizedStringForKey(
                    "Notification.Reminder.Title.InRoom",
                    null,
                    null
                ).convertParametersForPrintf(), it.cstr
            )
        } ?: ""
        return NSString.stringWithFormat(
            bundle.localizedStringForKey(
                ...
                null,
                null
            ).convertParametersForPrintf(), ending.cstr
        )
    }
    ...
    override fun reminderBody(sessionTitle: String): String {
        return NSString.stringWithFormat(
            bundle.localizedStringForKey(
                ...
                null,
                null
            ).convertParametersForPrintf(), sessionTitle.cstr
        )
    }
