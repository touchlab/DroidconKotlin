...
class SqlDelightRoomRepository(private val roomQueries: RoomQueries) :
    ...
    override fun allSync(conferenceId: Long): List<Room> = 
        roomQueries.selectAll(conferenceId, ::roomFactory).executeAsList()
    ...
    override fun contains(id: Room.Id, conferenceId: Long): Boolean = 
        roomQueries.existsById(id.value, conferenceId).executeAsOne() != 0L

    private fun roomFactory(id: Long, conferenceId: Long, name: String) = 
        Room(id = Room.Id(id), name = name)
}
