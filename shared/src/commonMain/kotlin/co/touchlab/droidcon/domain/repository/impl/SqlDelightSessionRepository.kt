...
class SqlDelightSessionRepository(
    ...
    override fun observe(id: Session.Id): Flow<Session> {
        return sessionQueries.sessionById(id.value, ::sessionFactory).asFlow().mapToOne(Dispatchers.Default)
    }
    ...
    override fun observeOrNull(id: Session.Id): Flow<Session?> {
        return sessionQueries.sessionById(id.value, ::sessionFactory).asFlow().mapToOneOrNull(Dispatchers.Default)
    }

    override fun observeAllAttending(): Flow<List<Session>> {
        return sessionQueries.attendingSessions(::sessionFactory).asFlow().mapToList(Dispatchers.Default)
    }
    ...
    override fun observeAll(): Flow<List<Session>> {
        return sessionQueries.allSessions(::sessionFactory).asFlow().mapToList(Dispatchers.Default)
    }
