...
object Deps {
    ...
    object Navigation {
        val safe_args = "androidx.navigation:navigation-safe-args-gradle-plugin:${Versions.nav_version}"
        val fragment_ktx = "androidx.navigation:navigation-fragment-ktx:${Versions.nav_version}"
        val ui_ktx = "androidx.navigation:navigation-ui-ktx:${Versions.nav_version}"
    }
    object Stately {
        val stately_common = "co.touchlab:stately-common:${Versions.stately}"
        val stately_concurrency = "co.touchlab:stately-concurrency:${Versions.stately}"
        val stately_collections = "co.touchlab:stately-collections:${Versions.stately}"
    }
    ...
    object Firebase {
//        val androidCore = "com.google.firebase:firebase-core:${versions.firebase}"
        val androidMessaging = "com.google.firebase:firebase-messaging"
        /*
        'androidCore'     : "com.google.firebase:firebase-core:${versions.firebase}",
                    'androidMessaging': "com.google.firebase:firebase-messaging:22.0.0",
         */
    }
